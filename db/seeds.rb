...
spot1 = Spot.new(name: "Miami Beach", latitude: rand() * 90, longitude: rand() * 180, description: "Hi there this is a nice place in miami for camping.")
spot1.user = user1
spot1.save

spot2 = Spot.new(name: "Southpole", latitude: rand() * 90, longitude: rand() * 180, description: "Southpole. Flat out stunning landscape. Haven't found an single eis-beergen")
spot2.user = user1
spot2.save

spot3 = Spot.new(name: "Bavaria", latitude: rand() * 90, longitude: rand() * 180, description: "Bavariaaaaaaa")
spot3.user = user3
spot3.save

spot4 = Spot.new(name: "Berlin", latitude: rand() * 90, longitude: rand() * 180, description: "Berlin. City of awsome")
spot4.user = user3
spot4.save

spot5 = Spot.new(name: "Santa Cruz", latitude: rand() * 90, longitude: rand() * 180, description: "Santa Cruz. Home town to crazy mfkrs.")
spot5.user = user2
spot5.save
